...
public final class CodeBlockChecker extends ListenerAdapter {
    ...
    private static final String[] KEYWORDS = {"auto", "break", "case", "char", "const", "Integer", "continue", "default", "do", "double", "else", "enum", "extern", "float", "for", "goto", "if", "int", "long", "register", "return", "short", "signed", "sizeof", "static", "struct", "switch", "typedef", "union", "unsigned", "void", "volatile", "while", "_Packed", "abstract", "byte", "class", "extends", "import", "private", "throws", "assert", "final", "instanceof", "native", "protected", "synchronized", "transient", "while", "boolean", "and", "catch", "finally", "this", "try", "char", "implements", "interface", "package", "def", "elif", "except", "exec", "from", "global", "is", "in", "lambda", "not", "pass", "or", "print", "raise", "yield", "val", "var", "let", "typeof", "null", "function", "func", "foreach", "explicit", "sealed", "ulong", "unchecked", "base", "checked", "unsafe", "readonly", "operator", "fixed", "out", "ref", "decimal", "uint", "<head>", "<title>", "<body>", "<html>", "<meta>", "<link>", "<style>", "<script>", "<div>", "<span>", "<br>", "<hr>", "<h1>", "<h2>", "<h3>", "<h4>", "<h5>", "<h6>", "<p>", "<a>", "<i>", "<u>", "<strong>", "<em>", "<ol>", "<ul>", "<li>", "<dl>", "<dt>", "<dd>", "<table>", "<tr>", "<th>", "<td>", "<tbody>", "<thead>", "<tfoot>", "<col>", "<colgroup>", "<caption>", "<form>", "<input>", "<button>", "<select>", "<option>", "<textarea>", "<label>", "<fieldset>", "<legend>",};
