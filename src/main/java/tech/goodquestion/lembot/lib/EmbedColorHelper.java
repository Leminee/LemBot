...
public final class EmbedColorHelper {
    ...
    public static final String HELP = "0x393e86";
    public static final String CONFIRMATION = "0x008000";
    public static final String INFORMATION = "0x000080";
    public static final String ERROR = "0xFF0000";
    ...
    public static final String HIGHLIGHTED_CODE_BLOCK = "";
    public static final String JOIN_DATE = "";
    public static final String NEXT_BUMP_TIME = "";
    public static final String SERVER_ROLES = "";
    public static final String BUMP = "0x40e0d0";
