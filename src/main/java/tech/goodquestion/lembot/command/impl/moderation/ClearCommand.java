...
public class ClearCommand implements BotCommand {
    ...
    public void dispatch(Message msg, TextChannel channel, Member sender, String[] args) {
        ...
        try {
            ...
            List<Message> messagesToDelete = msg.getChannel().getHistory().retrievePast(messageAmountToDelete).complete();
            ...
            Helper.createEmbed(confirmationEmbed, "Bestätigung", "Es wurden " + (messageAmountToDelete - 1) + " Nachrichten durch " + msg.getAuthor().getAsMention() + " erfolgreich gelöscht!", Color.GREEN);
