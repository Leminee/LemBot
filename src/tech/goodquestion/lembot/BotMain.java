...
import tech.goodquestion.lembot.command.*;
import tech.goodquestion.lembot.command.db.*;
import tech.goodquestion.lembot.command.moderation.MessageDeletion;
import tech.goodquestion.lembot.command.moderation.UserBanishment;
import tech.goodquestion.lembot.command.moderation.UserUnMute;
import tech.goodquestion.lembot.config.command.UpdatingChannel;
import tech.goodquestion.lembot.config.command.UpdatingRole;
